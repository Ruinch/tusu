...
const dictionaries: Record<AppLanguage, Dictionary> = {
  ru: {
    ...
    buildRoute: 'Построить маршрут', routeLead: 'Поступление', routeAccent: 'без догадок.', routeDescription: 'Анкета за 3 минуты → персональная диагностика → подбор вузов с шансами и стипендиями → пошаговый план до зачисления.',
  ...
  kk: {
    ...
    buildRoute: 'Маршрут құру', routeLead: 'Оқуға түсу', routeAccent: 'болжамсыз.', routeDescription: '3 минуттық сауалнама → жеке диагностика → мүмкіндігіңіз бен гранттары бар университеттер → оқуға түсуге дейінгі жоспар.',
  ...
  en: {
    ...
    buildRoute: 'Build my route', routeLead: 'Admissions', routeAccent: 'without guesswork.', routeDescription: 'A 3-minute profile → personal diagnostics → universities with fit and scholarships → a step-by-step plan to enrolment.',
